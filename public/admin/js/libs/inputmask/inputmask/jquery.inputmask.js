    ...
    function maskScope(actionObj, maskset, opts) {
        function getMaskTemplate(baseOnInput, minimalPos, includeInput) {
            ...
            do {
              ...
              ***REMOVED*** else {
                  ...
                  ***REMOVED*** else testPos = getTestTemplate(pos, ndxIntlzr, pos - 1);
                    ...
                    if (void 0 != match.matches) {
                      ...
                      ***REMOVED*** else if (match.isAlternator) {
                          ...
                          ***REMOVED*** else match = handleMatch(alternateToken.matches[altIndex], [ altIndex ].concat(loopNdx), quantifierRecurse);
                            if (match) return !0;
                      ***REMOVED*** else if (match.isQuantifier && quantifierRecurse !== !0) {
                            var qt = match;
      ...
      ***REMOVED***
        function getMaskLength() {
            ...
            0 == opts.greedy) {
                ...
                maskLength = pos;
          ***REMOVED*** else maskLength = getBuffer().length;
      ...
      ***REMOVED***
        function keydownEvent(e) {
          ...
          ***REMOVED***, 0) : k == $.inputmask.keyCode.HOME && !e.shiftKey || k == $.inputmask.keyCode.PAGE_UP ? caret(input, 0, e.shiftKey ? pos.begin : 0) : opts.undoOnEscape && k == $.inputmask.keyCode.ESCAPE || 90 == k && e.ctrlKey ? (checkVal(input, !0, !1, undoValue.split("")), 
