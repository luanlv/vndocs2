...
***REMOVED***
  ...
  ***REMOVED***
    ...
    dsv.parse = function(text) {
      ...
      return dsv.parseRows(text, function(row, i) {
        if (i) {
          var o = {***REMOVED***, j = -1, m = header.length;
  ...
  ***REMOVED***;
    ...
    ***REMOVED***
      var EOL = {***REMOVED***, EOF = {***REMOVED***, rows = [], n = 0, t, eol;
      reParse.lastIndex = 0;
      while ((t = token()) !== EOF) {
        var a = [];
        while (t !== EOL && t !== EOF) {
...
***REMOVED***
  ...
  ***REMOVED***;
    ...
    ***REMOVED***,
      leftBound: function(p) {
        ...
        do {
          he = he.r;
      ***REMOVED*** while (he != EdgeList.rightEnd && Geom.rightOf(he, p));
        he = he.l;
        return he;
    ***REMOVED***,
      del: function(he) {
  ...
  ***REMOVED***;
    ...
    ***REMOVED***,
      del: function(he) {
        for (var i = 0, ls = EventQueue.list, l = ls.length; i < l && ls[i] != he; ++i) {***REMOVED***
        ls.splice(i, 1);
    ***REMOVED***,
      empty: function() {
  ...
  ***REMOVED***;
    ...
    ***REMOVED*** else if (!EventQueue.empty()) {
...
***REMOVED*** : function(array, prototype) {
...
***REMOVED***;
  d3.nest = function() {
    function map(array, depth) {
      ...
      var i = -1, n = array.length, key = keys[depth++], keyValue, object, valuesByKey = new d3_Map, values, o = {***REMOVED***;
      while (++i < n) {
...
***REMOVED***, d3_selectRoot = document.documentElement, d3_selectMatcher = d3_selectRoot.matchesSelector || d3_selectRoot.webkitMatchesSelector || d3_selectRoot.mozMatchesSelector || d3_selectRoot.msMatchesSelector || d3_selectRoot.oMatchesSelector, d3_selectMatches = function(n, s) {
...
***REMOVED***;
  ...
  ***REMOVED*** : (value = value | 0, function(node) {
      node.delay = value;
  ***REMOVED***));
***REMOVED***;
  ...
  ***REMOVED*** : (value = Math.max(1, value | 0), function(node) {
      node.duration = value;
  ***REMOVED***));
***REMOVED***;
...
***REMOVED***;
  var d3_tweenRemove = {***REMOVED***;
  var d3_timer_id = 0, d3_timer_byId = {***REMOVED***, d3_timer_queue = null, d3_timer_interval, d3_timer_timeout;
  ...
  ***REMOVED***
    ...
    if (timer && timer.callback === callback) {
      timer.then = then;
      timer.delay = delay;
  ***REMOVED*** else d3_timer_byId[callback.id = ++d3_timer_id] = d3_timer_queue = {
      callback: callback,
      then: then,
      delay: delay,
      next: d3_timer_queue
...
***REMOVED***;
  ...
  ***REMOVED***
    function dragmove(d) {
      ...
      force.resume();
  ***REMOVED***
    var force = {***REMOVED***, event = d3.dispatch("start", "tick", "end"), size = [ 1, 1 ], drag, alpha, friction = .9, linkDistance = d3_layout_forceLinkDistance, linkStrength = d3_layout_forceLinkStrength, charge = -30, gravity = .1, theta = .8, interval, nodes = [], links = [], distances, strengths, charges;
    force.tick = function() {
      if ((alpha *= .99) < .005) {
        event.end({
          type: "end",
  ...
  d3.geom.hull = function(vertices) {
    ...
    for (i = 1; i < len; ++i) {
      if (vertices[i][1] < vertices[h][1]) {
        h = i;
    ***REMOVED*** else if (vertices[i][1] == vertices[h][1]) {
...
***REMOVED***);
  ...
  var d3_time_scaleLocalFormats = [ [ d3.time.format("%Y"), function(d) {
    return true;
***REMOVED*** ], [ d3.time.format("%B"), function(d) {
    return d.getMonth();
***REMOVED*** ], [ d3.time.format("%b %d"), function(d) {
    return d.getDate() != 1;
***REMOVED*** ], [ d3.time.format("%a %d"), function(d) {
    return d.getDay() && d.getDate() != 1;
***REMOVED*** ], [ d3.time.format("%I %p"), function(d) {
    return d.getHours();
***REMOVED*** ], [ d3.time.format("%I:%M"), function(d) {
    return d.getMinutes();
***REMOVED*** ], [ d3.time.format(":%S"), function(d) {
    return d.getSeconds();
***REMOVED*** ], [ d3.time.format(".%L"), function(d) {
...
***REMOVED***);
  var d3_time_scaleUTCFormats = [ [ d3.time.format.utc("%Y"), function(d) {
    return true;
***REMOVED*** ], [ d3.time.format.utc("%B"), function(d) {
    return d.getUTCMonth();
***REMOVED*** ], [ d3.time.format.utc("%b %d"), function(d) {
    return d.getUTCDate() != 1;
***REMOVED*** ], [ d3.time.format.utc("%a %d"), function(d) {
    return d.getUTCDay() && d.getUTCDate() != 1;
***REMOVED*** ], [ d3.time.format.utc("%I %p"), function(d) {
    return d.getUTCHours();
***REMOVED*** ], [ d3.time.format.utc("%I:%M"), function(d) {
    return d.getUTCMinutes();
***REMOVED*** ], [ d3.time.format.utc(":%S"), function(d) {
    return d.getUTCSeconds();
***REMOVED*** ], [ d3.time.format.utc(".%L"), function(d) {
